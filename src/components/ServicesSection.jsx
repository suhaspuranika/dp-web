  ...
  const services = [
    {
      ...
      image: '/images/Data-Architeture-and-design.png',
      description:
        'We help customers to build a firm foundation for business intelligence by leveraging our expertise across the data lifecycle with strong architecture, solution design and data strategy.Our expertise enables us to combine the best technologies and proven approach to deliver the most effective results and provide you with solutions that can help you collect relevant, understandable, and accurate data displayed in real time.We deliver on strategy, MVPs, PoCs and real-world ventures taking full advantage of big data and data lake paradigms.',
      tags: ['Data lakes', 'Architecture', 'Real-time pipelines'],
    },
    {
      id: 2,
    ...
    },
    {
      ...
      tags: ['Forecasting', 'Classification', 'MLOps'],
    },
    {
      id: 4,
      ...
      description:
        'We aid customers brings data to life using Data visualization, making the master storyteller of the insights hidden within numbers. Through live dashboards, interactive reports, charts, graphs, and other visual representations, data visualization helps users develop powerful business insight quickly and effectively We demonstrate an understanding of the strategic value of information, data management, and Business Intelligence to organisational decision-making activities, analyse large corporate datasets using complementary Business Intelligence/Business Analytics tools to generate insights and provide alternative solutions to an organisation complex problems',
      tags: ['Dashboards', 'Self-service BI', 'Storytelling'],
    },
    {
      id: 5,
      ...
      tags: ['Policies & Controls', 'Lineage', 'Compliance'],
    },
    {
      id: 6,
      ...
      description:
        'We are experienced in a variety of cloud computing solutions, such as cloud migration strategy, cloud migration services and cloud-native design and development.As a consulting and technology solutions company, we also can provide integrated solutions that complement technical cloud work.We offer full range of support for Digital solutions on major cloud platform including AWS, Azure and GCP.',
      tags: ['AWS / Azure / GCP', 'DevOps', 'Scalability'],
    },
    {
      id: 7,
      ...
      tags: ['Automation', 'Performance', 'Testing'],
    },
  ];
            ...
            >
              <div className="service-media">
                <div className="service-image-wrap">
                  <img className="service-image" src={s.image} alt={s.title} />
                </div>
                <div className="service-index">{String(s.id).padStart(2, '0')}</div>
              </div>
